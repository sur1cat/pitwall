...
private let ru: [String: String] = [
    ...
    "Rules": "Права",
    "What changed under you": "Что изменилось под тобой",
    "Settings worth changing": "Что стоит изменить в настройках",
    "What pitwall can read": "Что pitwall может прочитать",
    "Insights": "Разбор",
    "Habits": "Привычки",
    "7 days": "7 дней",
